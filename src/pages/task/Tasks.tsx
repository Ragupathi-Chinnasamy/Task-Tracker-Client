...
function Tasks() {
  ...
  const { data: taskTypes, fetchData: fetchTaskTypes } = useTaskTypeStore();
  const { data: taskStatus, fetchData: fetchTaskStatus } = useTaskStatusStore();
  const {
    projectId,
    assigneeId,
    statusId,
          ...
          <div className="space-y-4 px-4 pb-4">
            ...
            <div className="flex gap-2">
              <button
                ...
                className="rounded-md px-4 py-2 bg-gray-200/70 border border-solid border-gray-300 w-1/2 font-semibold shadow-sm cursor-pointer active:scale-95"
              >
                Clear filter
              </button>
              <CustomButton
